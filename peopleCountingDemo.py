...
def serialConfig(configFileName):
    ...
    # Raspberry pi
    CLIport = serial.Serial('/dev/cu.usbmodemR00510281', 115200)
    Dataport = serial.Serial('/dev/cu.usbmodemR00510284', 921600)
...
def update():
    ...
    if targetDetected:
        ...
        requests.post("http://lol", data={"numberOfTargets": targetObj["numTargets"]})
